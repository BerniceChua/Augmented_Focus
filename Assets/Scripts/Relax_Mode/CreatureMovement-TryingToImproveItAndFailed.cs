...
public class CreatureMovementTryingToImproveItAndFailed : MonoBehaviour {
    ...
    void FixedUpdate() {
        ...
        //    DoNotGoTooFar();
        //    Debug.Log("Hello");
        //    transform.Translate(Vector3.forward * Random.Range(0.0f, 1.50f) * Time.deltaTime);
        //    Debug.Log("I passed `transform.Translate(Vector3.forward * Random.Range(0.0f, 1.50f) * Time.deltaTime);`.");
        //}
    ...
    void DoNotGoTooFar() {
        ...
        transform.localPosition = Vector3.MoveTowards(transform.position, new Vector3(x, y, z), Random.Range(-m_maxSpeed, m_maxSpeed) * Time.deltaTime);
    }
