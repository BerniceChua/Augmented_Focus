...
public class CeratocanthusCameraScript : MonoBehaviour {
	public GameObject target;
	public GameObject ceratocanthusCamera;
	...
	void Update(){
		...
		ceratocanthusCamera.transform.localPosition = new Vector3 (0f,cameraDistance,-2f*cameraDistance);
	}
	...
	void FixedUpdate(){
		transform.position = Vector3.Lerp (transform.position,target.transform.position,Time.deltaTime*50f);
	}
}
